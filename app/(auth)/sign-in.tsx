        ...
        <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
            ...
            <View style={styles.mainCard}>
                ...
                <View className="space-y-4">
                    ...
                    <Pressable
                        ...
                        style={({ pressed }) => [
                            ...
                            (loading || !phone) && { backgroundColor: "#108962", opacity: 0.7 }
                        ]}
                    >
                        {loading ? (
                            <ActivityIndicator color="#fff" />
                ...
                <View className="flex-row justify-center items-center mt-6">
                    <Text className="text-sm text-[#6B8260] font-medium">Don't have an account? </Text>
                    <Link href={"/sign-up" as any} asChild>
                        <Pressable>
                            <Text className="text-sm font-bold text-[#0B6E4F]">Sign Up</Text>
                        </Pressable>
                    </Link>
                </View>
            </View>
